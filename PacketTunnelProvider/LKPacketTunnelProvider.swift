...
/// The idea here is to intercept packets, pass them to the Lokinet core so that it can modify them
/// as described by the LLARP Traffic Routing Protocol, and then pass them to the appropriate snode(s).
